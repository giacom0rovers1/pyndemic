 ...
 \end{align}
  ...
  \subsection{Numerical solutions}
	...
	\begin{figure}[h]
		...
		\caption{\textbf{Left}: Typical evolution of a SEIR model. \textbf{Right}: Effective reproduction numbers.} %  $R(t)$ and $R_K(t)$
		\label{fig:SEIRboth}
	\end{figure}
