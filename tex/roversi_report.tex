...
The initial growth coefficient $K_0$ for the SEIR model is the bigger eigenvalue of the evolution operator and it is obtained solving the equation: 
 ...
 \end{align}
  ...
  \subsection{Numerical solutions}
	The time-continuous evolutions of both SIR and SEIR deterministic models are calculated integrating the differential equations with an ODE solver of the \textit{SciPy} python library (I uploaded all the code at \citet{pyndemic}). 	% TODO Inserire codice in appendice? Release GitHub?
